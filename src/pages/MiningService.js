...
import mine1 from '../pictures/about-image.jpg';
import mine2 from '../pictures/mining.jpg';
import mine3 from '../pictures/pic-2.jpg';

export default function MiningServices() {
  return (
    <div className="mining-page container py-5">
