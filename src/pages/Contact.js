...
export default function ContactUs() {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("_gotcha", ""); // leave empty for human users

    try {
      const res = await fetch("https://formspree.io/f/xzzywkzv", {
        method: "POST",
        headers: {
        ...
        <div className="row g-4">
          ...
          <div className="col-md-6">
            <div className="contact-box p-4 rounded-4 shadow-sm">
              <h4 className="text-center fw-bold text-purple mb-4">Contact Us</h4>
          ...
          <div className="col-md-6">
            <div className="contact-box p-4 rounded-4 shadow-sm">
              ...
              <p>
                <strong>About Our Contacts:</strong>
                <br />
                Feel free to reach out to us whether it's an inquiry,
                <br /> a question, concern, or any other reason.
              </p>
            </div>
          </div>
        </div>
...
//     try {
//       const res = await fetch("https://formspree.io/f/xvgdyqeb", {
//         method: "POST",
//         headers: {
//           Accept: "application/json",
//         },
