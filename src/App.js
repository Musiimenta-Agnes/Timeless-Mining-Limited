...
import ElectricityServices from './pages/Electricity';
import MiningServices from './pages/MiningService';
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/mining" element={<MiningServices />} />
        <Route path="/services" element={<ServicesPage />} />
        <Route path="/gallery" element={<Gallery />} />
        <Route path="/license" element={<LicensePage />} />
        <Route path="/electricity" element={<ElectricityServices />} />
